...
func _show_screen(info: Dictionary = {}) -> void:
	...
	var result: NakamaAPI.ApiLeaderboardRecordList = await Online.nakama_client.list_leaderboard_records_async(Online.nakama_session, 'fish_game_wins').completed
